  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless table reservations and menu management with Restaurant Booking Engine v4 - Revolutionizing Restaurant Management One Reservation at a Time."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless table reservations and menu management with Restaurant Booking Engine v4 - Revolutionizing Restaurant Management One Reservation at a Time.`}
            </Text>
            <Box
